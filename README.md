...
- first enter your informations to database on ".env" file,
- After enter your informations to mail account on "boilerplate/lib/services/mail.js" file, in the transporteur variable,
- run "node server" to start the project.
